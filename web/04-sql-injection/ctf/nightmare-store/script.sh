...
#use ORDER BY to determine number of columns, then use union select and group conctat, after revealing
#all the tables in the database (the most difficult part) and there you will find everything you need

url='http://141.85.224.118:8081'
